...
describe("Test Amazon Clone", () => {
  ...
  describe("Listing", () => {
    ...
    beforeEach(async () => {
      // List a item
      transaction = await contract.connect(deployer).list(ID, NAME, CATEGORY, IMAGE, COST, RATING, STOCK)
  ...
  describe("Buying", () => {
    ...
    it("Updates the contract balance", async () => {
      const result = await ethers.provider.getBalance(contract.address)
  ...
  describe("Withdrawing", () => {
    ...
    beforeEach(async () => {
      // List a item
      let transaction = await contract.connect(deployer).list(ID, NAME, CATEGORY, IMAGE, COST, RATING, STOCK)
      await transaction.wait()
